//g++ vgg.cpp -g -std=c++11 -I ../include/ -I ../tools/ -L ../bin/ -lHalide `libpng-config --cflags --ldflags` -ljpeg -o vgg
#include "Halide.h"
#include "clock.h"
#include <stdio.h>
...
RDom r(0, 3, 0, 3, 0, O);//3*3*o 3*3*64 or 1
int pad=1.5;
...
Func convertb("convertb"),output("output");
...
//save output image
//convert_and_save_image(output_im,"blh.png");
double t2 = current_time();
cout<<"milliseconds:"<<(t2-t1)/100<<endl;
